...
public class Input implements InputProcessor, ControllerListener {
    ...
    public boolean buttonDown(Controller controller, int buttonCode) {
        switch (buttonCode) {
            case 0:
                keyDown(KeyBindings.ENTER);
                break;
            case 1:
                keyDown(KeyBindings.BACK);
                break;
            case 6:
                keyDown(KeyBindings.ESC);
                break;
            case 7:
                keyDown(KeyBindings.START);
                break;
            default:
                break;
        }
    ...
    public boolean povMoved(Controller controller, int povCode,
        ...
        switch (value) {
            case east:
                keyDown(KeyBindings.RIGHT);
                break;
            case north:
                keyDown(KeyBindings.UP);
                break;
            case west:
                keyDown(KeyBindings.LEFT);
                break;
            case south:
                keyDown(KeyBindings.DOWN);
                break;
            default:
                break;
        }
